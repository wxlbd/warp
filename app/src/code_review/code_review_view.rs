...
impl DiscardOperationType {
    ...
    pub fn description(&self, app: &AppContext) -> Option<String> {
        match self {
            ...
            DiscardOperationType::AllChangesAgainstBranch(None) => Some(code_review_text(
                app,
            ...
            DiscardOperationType::AllChangesAgainstBranch(Some(_)) => Some(code_review_text(
                app,
                "code_review.discard.description.all_changes",
            )),
        ...
        match mode {
            PrimaryGitActionMode::Commit => {
                ...
                self.git_primary_action_button.update(ctx, |button, ctx| {
                    ...
                    button.set_tooltip(
                        Some(if disabled {
                            code_review_text(ctx, "code_review.git.no_changes")
                        } else {
                            code_review_text(ctx, "code_review.git.commit_changes_locally")
                        }),
                        ctx,
                    );
                    button.set_on_click(
            ...
            PrimaryGitActionMode::CreatePr => {
                self.git_primary_action_button.update(ctx, |button, ctx| {
                    ...
                    button.set_disabled(false, ctx);
                    button.set_tooltip(
                        Some(code_review_text(ctx, "code_review.git.create_pull_request")),
                        ctx,
                    );
                    button.set_on_click(
                    ...
                    self.git_primary_action_button.update(ctx, |button, ctx| {
                        ...
                        button.set_tooltip(
                            Some(if is_pr_info_refreshing {
                                ...
                                code_review_text(ctx, "code_review.git.view_pull_request")
                            }),
                            ctx,
                        );
                        button.set_on_click(
