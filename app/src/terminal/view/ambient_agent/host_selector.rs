...
const DEFAULT_BADGE_KEY: &str = "terminal.ambient_agent.host_selector.badge.default";

const CONNECTED_BADGE_KEY: &str = "terminal.ambient_agent.host_selector.badge.connected";

const DISCONNECTED_BADGE_KEY: &str = "terminal.ambient_agent.host_selector.badge.disconnected";
...
fn build_menu_items(
    ...
    let default_badge = text(ctx, DEFAULT_BADGE_KEY);
    let connected_badge = text(ctx, CONNECTED_BADGE_KEY);
    let disconnected_badge = text(ctx, DISCONNECTED_BADGE_KEY);
