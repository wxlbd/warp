...
static PLUGIN_INSTALL_INSTRUCTIONS: LazyLock<PluginInstructions> =
    LazyLock::new(|| PluginInstructions {
        ...
        post_install_note_keys: &[
            ...
            "terminal.plugin_instructions.codex.plugin_install.note.no_separate_install",
        ],
        post_install_notes: &[
...
static NATIVE_INSTALL_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| {
    PluginInstructions {
        title_key: "terminal.plugin_instructions.codex.native_install.title",
        title: "Enable Warp Notifications for Codex",
        subtitle_key: "terminal.plugin_instructions.codex.native_install.subtitle",
        ...
        steps: &[
            PluginInstructionStep {
                description_key: "terminal.plugin_instructions.codex.native_install.step.update",
            ...
            PluginInstructionStep {
                description_key: "terminal.plugin_instructions.codex.native_install.step.configure",
        ...
        post_install_note_keys: &["terminal.plugin_instructions.codex.native_install.note.restart"],
...
static PLUGIN_UPDATE_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| {
    PluginInstructions {
        ...
        post_install_note_keys: &[
            ...
            "terminal.plugin_instructions.codex.plugin_update.note.readd_marketplace",
        ],
        post_install_notes: &[
