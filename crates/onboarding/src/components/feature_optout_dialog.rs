...
pub fn render_feature_optout_dialog(
    ...
    let title = FormattedTextElement::from_str(title, appearance.ui_font_family(), 16.)
    ...
    let body_text = FormattedTextElement::from_str(body, appearance.ui_font_family(), 14.)
        .with_color(internal_colors::text_main(theme, dialog_surface_solid))
    ...
    let footer = Container::new(
        Flex::row()
            ...
            .with_child(Container::new(confirm_button).with_margin_left(8.).finish())
            .finish(),
    )
